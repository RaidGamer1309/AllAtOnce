...
@Composable
fun AccelerometerModule(panelMode: PanelMode, modifier: Modifier = Modifier) {
    ...
    ModulePanel(label = "Accelerometer", status = status, modifier = modifier) {
        AxisReadout(x = x, y = y, z = z, unit = "m/s²")
    }
}
